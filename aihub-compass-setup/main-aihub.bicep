...
module apimKvRole 'modules/apim-kv-role.bicep' = if (deployApim && deployCompassApi) {
  scope: rg
...
module compassApi 'modules/apim-compass-api.bicep' = if (deployApim && deployCompassApi) {
  scope: rg
